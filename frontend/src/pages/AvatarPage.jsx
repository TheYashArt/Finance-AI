...
import { Send, Loader2, Bot, User, Sparkles, Mic, Volume2, RefreshCcw, MicOff, VolumeOff, MessageSquare } from 'lucide-react';
...
const AvatarPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#030303] flex gap-2 relative">
            {/* Top Navigation */}
            <FloatingNav />
